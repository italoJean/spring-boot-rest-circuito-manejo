-- Script de Creación de Tablas de Quartz Scheduler (Versión 2.x) para MySQL
...
-- 12. Índices adicionales para mejorar el rendimiento de búsqueda
...
CREATE INDEX IF NOT EXISTS IDX_QRTZ_T_NFT_MFI ON QRTZ_TRIGGERS(SCHED_NAME,MISFIRE_INSTR,NEXT_FIRE_TIME);
CREATE INDEX IF NOT EXISTS IDX_QRTZ_T_NFT_ST_MFI ON QRTZ_TRIGGERS(SCHED_NAME,MISFIRE_INSTR,TRIGGER_STATE,NEXT_FIRE_TIME);
CREATE INDEX IF NOT EXISTS IDX_QRTZ_T_NFT_ST_MFI_G ON QRTZ_TRIGGERS(SCHED_NAME,MISFIRE_INSTR,TRIGGER_STATE,NEXT_FIRE_TIME,TRIGGER_GROUP);
